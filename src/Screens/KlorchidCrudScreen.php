...
abstract class KlorchidCrudScreen extends KlorchidMultiModeScreen
{
    ...
    public function commandBar(): array
    {
        ...
        if ($this->display_save_button == true and $this->userHasScreenActionPermission($this->getMode())) {
            array_push($commands, $this->saveButton());
        }

        if ($this->getDisplayStatusSetButton() and $this->userHasScreenActionPermission('status_set')) {
