...
namespace Kamansoft\Klorchid\Screens\Fields;
 ...
 */
class KlorchidRelation extends \Orchid\Screen\Field
{
    use Multipliable;
    ...
    public function editUrl(string $url)
    {

        \Debugbar::info($this->get('value'));
        $this->set('relationEditUrl', $url);
        return $this;
    }

    public function editRouteName(string $routeName)
    {

        $this->set('relationEditRouteName',$routeName);
        return $this;
    }
