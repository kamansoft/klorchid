...
class KlorchidMultiModeScreenCommand extends ScreenCommand
{
    ...
    protected $signature = 'klorchid:screen
        ...
        {repository? : The full repository name with its namespace like: \Namespace\Repositories\RepositoryName } 
     ...
     * @var string
     */
    protected $description = 'Generate a new klorchid klorchid multimode screen';
