...
use App\Orchid\Screens\PlatformScrenn;
...
| contains the need "dashboard" middleware group. also these routes were rewrited
| by the klorchid package to fit some needs. Now create something great!
|
 */
